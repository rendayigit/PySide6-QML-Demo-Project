...
class DataManager(QObject):
    ...
    def update_variable_value(self, variable_path: str, value: Any, variable_type: str) -> None:
        """
        ...
        self._watched_variables[variable_path].update({"value": formatted_value, "type": variable_type})
    ...
    def update_fields_data(self, fields_data: List[Dict[str, Any]]) -> None:
        ...
        for field in fields_data:
            ...
            variable_type = field.get("type")

            if variable_path and variable_path in self._watched_variables:
                self.update_variable_value(variable_path, value, variable_type)
