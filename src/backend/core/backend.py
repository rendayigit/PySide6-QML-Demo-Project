...
from ..communication.subscriber import ZMQSubscriber, SubscriberCallbacks
...
class Backend(QObject):
    ...
    def set_simulation_status(self, is_running: bool) -> None:
        ...
        if self._is_running != is_running:
            ...
            # Update status text based on running state
            if is_running:
                self.set_status_text("Simulation running")
            else:
                self.set_status_text("Simulation paused")
    ...
    def addVariableToWatch(self, variable_path: str, description: str = "") -> bool:
    ...
    def removeVariableFromWatch(self, variable_path: str) -> bool:
    ...
    @Slot(result=bool)
    def clearVariableTable(self) -> bool:
    ...
    @Slot(result=bool)
    def toggleSimulation(self) -> bool:
    ...
    def progressSimulation(self, total_milliseconds: int) -> bool:
    ...
    def setSimulationRate(self, scale_value: float) -> bool:
    ...
    @Slot(result=bool)
    def requestModelTree(self) -> bool:
